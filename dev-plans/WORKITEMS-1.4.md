...
- [ ] 27 I just tried a Schedule Once operation, and it didn't work. Please make sure that works. 
- [ ] 28 When I create a "once" schedule, the default date and time should be now. 
- [ ] 29 The schedule table should no longer show "once" jobs once they have executed.  
- [ ] 30 After the successful execution of a once job, we should also update the YAML to no longer have the schedule in it. 
