...
- [ ] **#9** *(environment, not code)* — hass-4 Supervisor Docker build cascade at 2026-04-14 10:48. The Supervisor tried to rebuild the add-on image `local/amd64-addon-esphome_dist_server:1.4.0-dev.52` and failed:
