...
- [ ] 184 can we indicate in the devices tab all the ways in which we resolved the IP (mDNS, use_address, static_ip) - i.e. for each IP (in small font) show how we resolved it.
